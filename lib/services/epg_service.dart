...
/// 与 channel_repository.dart 中的同名函数逻辑一致，避免依赖跨文件引入。
...
class EpgService {
  ...
  /// 关键修复: 用 UTC+8 偏移算绝对时刻, 不再用设备本地时区的 DateTime.now().
  void _scheduleNextRefresh() {
    ...
    debugPrint(
        'EpgService: 下次 EPG 刷新 ${delay.inHours}h${delay.inMinutes.remainder(60)}m 后 (Beijing ${bj.year}-${bj.month}-${bj.day} ${bj.hour}:${bj.minute})');
